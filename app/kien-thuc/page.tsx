        ...
        <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600 dark:text-slate-500 dark:text-slate-400">Tất cả quy trình, case xử lý sự cố và tài liệu dùng để chia sẻ cho khách hàng.</p>
                </div>
                <Link
                    href="/kien-thuc/moi"
                ...
                {(Object.entries(MODULE_CONFIG) as [string, typeof MODULE_CONFIG[keyof typeof MODULE_CONFIG]][]).map(([key, cfg]) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <p className="text-xs text-slate-600 dark:text-slate-500 dark:text-slate-400 mt-1">tài liệu</p>
                        </Link>
                    );
                })}
            </div>
            ...
            {articles.length === 0 ? (
                <div className="glass-panel rounded-2xl px-8 py-16 text-center">
                    ...
                    <p className="text-slate-600 dark:text-slate-500 dark:text-slate-400">Chưa có tài liệu nào. Nhấn &quot;Thêm Tài Liệu&quot; để bắt đầu.</p>
                </div>
            ) : (

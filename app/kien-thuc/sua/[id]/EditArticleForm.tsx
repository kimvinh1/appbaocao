        ...
        <form onSubmit={handleSubmit} className="glass-panel rounded-2xl p-6 space-y-4">
            ...
            <label className="block text-sm text-slate-700 dark:text-slate-300">
                ...
                <input
                    ...
                    className={`mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white/80 dark:bg-slate-900/80 px-3 py-2 text-sm text-white outline-none transition ${moduleTheme.focusBorderClass}`}
                />
            </label>
                        ...
                        {article.images.map((img) => (
                            <div key={img.id} className="relative group">
                                <img
                                    src={img.imageUrl}
                                    alt="Ảnh đính kèm"
                                    className="h-28 w-full rounded-lg object-cover border border-slate-300 dark:border-slate-700"
                                />
                                <form
            ...
            <label className="block text-sm text-slate-700 dark:text-slate-300">
                ...
                <input
                    ...
                    name="imageFiles"
                    multiple
                    className="mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white/80 dark:bg-slate-900/80 px-3 py-1.5 text-sm text-white outline-none file:mr-4 file:py-1 file:px-3 file:rounded file:border-0 file:text-xs file:font-semibold file:bg-slate-800 file:text-slate-300 hover:file:bg-slate-700"
                />
            </label>

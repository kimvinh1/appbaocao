      ...
      <div className="glass-panel rounded-2xl p-4">
        ...
        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-[11px] text-slate-600 dark:text-slate-500">Từ ngày</span>
            <input type="date" value={dateFrom} onChange={(e) => setDateFrom(e.target.value)}
              className={INPUT_CLS} />
          </div>
          <div className="flex flex-col gap-1">
            <span className="text-[11px] text-slate-600 dark:text-slate-500">Đến ngày</span>
                  ...
                  <td className="px-4 py-3 text-xs text-slate-500 dark:text-slate-400 max-w-[180px]">
                    {lastLog ? (
                      <div>
                        ...
                        <br />
                        <span className="text-slate-600 dark:text-slate-500 italic line-clamp-1">{lastLog.note}</span>
                      </div>

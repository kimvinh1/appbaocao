    ...
    <div className="space-y-4">
      ...
      {filtered.length === 0 ? (
        <div className="glass-panel rounded-2xl px-8 py-14 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400">Không tìm thấy mã lỗi phù hợp.</p>
          {hasFilter && (
              ...
              <summary className="p-4 flex cursor-pointer items-start justify-between gap-4 outline-none hover:bg-slate-800/40 transition list-none">
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <span className="text-xs text-slate-500 dark:text-slate-400 bg-slate-100/80 dark:bg-slate-800/80 px-2 py-0.5 rounded-full">{ec.instrument}</span>
                ...
                <div className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 group-open:rotate-180 transition-transform">▼</div>
              </summary>

...
- Soạn bài/quy trình trong Knowledge Base. Editor hỗ trợ paste nội dung từ Word, gồm heading, danh sách, bảng, link, định dạng cơ bản và ảnh dán kèm.
- Tạo link chia sẻ riêng cho từng khách hàng, chọn hạn dùng 3/7/14/30/90 ngày.
- Khách mở link public `/chia-se/[token]`, đọc quy trình, xác nhận hoàn tất và gửi phản hồi.
- App ghi nhận lần mở đầu tiên, lần mở gần nhất, số lần mở, trạng thái hoàn tất, phản hồi và đánh giá.
- Có thể tắt/thu hồi link; khách sẽ thấy trang thông báo link đã thu hồi hoặc hết hạn thay vì lỗi 404.
...
Các cột theo dõi link hỗ trợ trên `ProcedureShare`:
